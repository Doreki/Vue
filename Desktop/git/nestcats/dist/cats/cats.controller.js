...
const jwt_guard1_1 = require("../auth/jwt/jwt.guard1");
...
__decorate([
    (0, dist_1.ApiOperation)({ summary: '현재 고양이 가져오기' }),
    (0, common_1.UseGuards)(jwt_guard1_1.JwtAuthGuard1),
    (0, common_1.Get)(),
...
__decorate([
    ...
    (0, dist_1.ApiOperation)({ summary: '회원가입' }),
    (0, common_1.Post)(),
...
__decorate([
    (0, dist_1.ApiOperation)({ summary: '로그인' }),
    (0, common_1.Post)('login'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [login_request_dto_1.LoginRequestDto1]),
    __metadata("design:returntype", void 0)
], CatsController.prototype, "logIn", null);
__decorate([
    (0, dist_1.ApiOperation)({ summary: '로그아웃' }),
...
__decorate([
    (0, dist_1.ApiOperation)({ summary: '고양이 사진 업로드' }),
